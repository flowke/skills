...
需求来源 / 产品文档 / 设计稿 / 接口文档 / 项目资料
        ↓
Discuss：需求整理、需求细化、上下文管理、实现思路预对齐
        ↓
...
1. **原始需求不可被覆盖**
   ...
   - 后续理解、边界、默认方案和实现口径只能进入细化或实施字段，不能反向改写原始需求
...
原始需求是从产品文档、用户输入、issue 或其他需求来源中接收到的原始诉求。
...
### Requirement Refinement（需求细化）

需求细化是围绕某个原始需求，在讨论循环中补充出来的内容。
